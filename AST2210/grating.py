...
slit_width_slider = Slider(axis2, "Slit Width(mm)", 0.1, 2, valinit=slit_width*10**3)
screen_distance_slider = Slider(axis3, "Screen Distance(cm)", 10, 200, valinit= screen_distance*10**2)
...
def update(val) :
  ...
  slit_width = slit_width_slider.val*(10**-3)
