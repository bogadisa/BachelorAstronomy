...
from cocoSource_xcnnfused2 import ImageCaptionModel
import torch
...
def main(config, modelParam):
    ...
    # create an instance of the saver and resoterer class
...
if __name__ == '__main__':
    ...
    # data_dir = "C:/Users/magnu/Kode/BachelorAstronomy/IN3310/oblig2/student_version/"

    #train
    modelParam = {
        'batch_size': 128,  # Training batch size
        'cuda': {'use_cuda': torch.cuda.is_available(),  # Use_cuda=True: use GPU
