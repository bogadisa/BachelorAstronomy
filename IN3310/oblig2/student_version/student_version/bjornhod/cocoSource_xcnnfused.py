...
class RNNOneLayerSimplified(nn.Module):
    ...
    def forward(self, tokens, processed_cnn_features, initial_hidden_state, output_layer: nn.Linear,
        ...
        current_time_step_embeddings = all_embeddings[:, 0, :]#torch.squeeze(all_embeddings)  # Should have shape (batch_size, embedding_size)
        # print(current_time_step_embeddings.shape)
        # print(current_time_step_embeddings.size())
        # quit()
        # HMMMMMMMMMMMM!
